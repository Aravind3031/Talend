...
package talend_project.test_1_0_1;
...
public class Test_1 implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Test_1.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TALEND_PROJECT_Test_1 = new byte[0];
		static byte[] commonByteArray_TALEND_PROJECT_Test_1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALEND_PROJECT_Test_1.length) {
					if (length < 1024 && commonByteArray_TALEND_PROJECT_Test_1.length == 0) {
						commonByteArray_TALEND_PROJECT_Test_1 = new byte[1024];
					} else {
						commonByteArray_TALEND_PROJECT_Test_1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALEND_PROJECT_Test_1, 0, length);
				strReturn = new String(commonByteArray_TALEND_PROJECT_Test_1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALEND_PROJECT_Test_1) {
...
///////////////////////    			
				...
				int nb_max_row_tRowGenerator_1 = 25;
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Test_1.class.getClassLoader()
					.getResourceAsStream("talend_project/test_1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Test_1.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Test_1");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 52297 characters generated by Talend Cloud Data Management Platform on the 20
 * August, 2021 12:33:11 PM GMT+05:30
 ************************************************************************************************/